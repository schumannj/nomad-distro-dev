![docker image](https://github.com/schumannj/nomad-distro-dev/actions/workflows/docker-publish.yml/badge.svg)


# schumannj's NOMAD Oasis Distribution

This is the NOMAD Oasis distribution of schumannj.
...
2. Clone the repository or download the repository as a zip file.
    ...
    ```sh
    git clone https://github.com/schumannj/nomad-distro-dev.git
    cd nomad-distro-dev
    ```
    ...
    ```sh
    curl-L -o nomad-distro-dev.zip "https://github.com/schumannj/nomad-distro-dev/archive/main.zip"
...
your `docker-compose.yaml` with `ghcr.io/schumannj/nomad-distro-dev:main` for the services
...
```
docker pull ghcr.io/schumannj/nomad-distro-dev/jupyter:main
```
...
_I get an_ `Error response from daemon: Head "https://ghcr.io/v2/schumannj/nomad-distro-dev/manifests/main": unauthorized`
